...
CREATE VIEW recipes_with_favorite_counts AS
SELECT recipe.*, COUNT(favorites.id) AS favoriteCount
FROM recipe
...
VALUES (
        ...
        "https://images.unsplash.com/photo-1622973536968-3ead9e780960?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        "dinner",
        "691b95d9426378972ae47eb6"
    );
...
FROM
    favorites
    RIGHT JOIN recipe ON favorites.recipe_id = recipe.id
WHERE
    favorites.id = 75;


SELECT * FROM favorites WHERE id = 75;

DELETE FROM favorites WHERE id = 75;
